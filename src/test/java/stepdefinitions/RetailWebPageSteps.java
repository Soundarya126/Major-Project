...

{
	...
	public void browsersetup()
	{
		...
		System.setProperty("webdriver.chrome.driver", "C:\\CAPGEMINI\\CG Training\\Selenium & Cucumber\\chromedriver_win32\\chromedriver.exe");  
	...
	public void enters_the_all_details_in_required_fields() {

		//Entering all details in required fields	
		driver.findElement(By.xpath("//*[@id='input-firstname']")).sendKeys("Dornala");	
		driver.findElement(By.xpath("//*[@id='input-lastname']")).sendKeys("Reddy");
		driver.findElement(By.xpath("//*[@id='input-address-1']")).sendKeys("H.No:1/10, Nizamabad");
		driver.findElement(By.xpath("//*[@id='input-city']")).sendKeys("Nizamabad");
		driver.findElement(By.xpath("//*[@id='input-postcode']")).sendKeys("503001");

		//Country dropdown locator
		...
		//Region dropdown locator
		By region = By.xpath("//*[@id='input-zone']");

		Select select2 = new Select(driver.findElement(region));
	...
	@Then("User Enters the Quantity and  Delivery pincode")
	public void user_enters_the_quantity_and_delivery_pincode() {

		WebElement r1 = driver.findElement(By.xpath("//*[@name='quantity']"));
		r1.clear();
		r1.sendKeys("2");

		driver.findElement(By.xpath("//*[@name='pincode']")).sendKeys("503001");
	}
	...
	public void customer_opens_the_site() {
		System.setProperty("webdriver.chrome.driver", "C:\\Training\\Selenium\\chromedriver_win32\\chromedriver.exe"); //driver path
		driver = new ChromeDriver();
		driver.get("http://retailm1.upskills.in/");  //site URL
		driver.manage().window().maximize();
	...
	public void enters_in_to_the_login_page() {

		WebElement profile;	//Declaring the web element profile
		profile=driver.findElement(By.xpath("//*[@id='Menu_Wmt3OMY3']/nav/ul/li[2]/a"));//Path for the profile

		Actions action=new Actions(driver);//Action to perform
		action.moveToElement(profile).click().build().perform();
		driver.findElement(By.xpath("//*[@id='input-email']")).sendKeys("sreedharreddy2970@gmail.com");//Entering email id
		driver.findElement(By.xpath("//*[@name='password']")).sendKeys("Sreedhar@12");//Entering password
		driver.findElement(By.xpath("//*[@value='Login']")).click();//clicking on the login button

	}

	@When("Under my account click on change password")
	public void under_my_account_click_on_change_password() { 

		driver.findElement(By.xpath("/html/body/div/section[2]/div/div/div/div/div/div/align/ul/li[2]/a")).click(); //clicks on the change password

	}

	@When("Enter the password text and click contiue")
	public void enter_the_password_text_and_click_contiue() {

		driver.findElement(By.xpath("//*[@id=\"input-password\"]")).sendKeys("Sreedhar@12");//New password
		driver.findElement(By.xpath("//*[@name='confirm']")).sendKeys("Sreedhar@12");
		driver.findElement(By.xpath("//*[@id=\"System_s3bhXNDb\"]/form/div/div[2]/input")).click(); //continue/submit password
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

	}

	@Then("customer will receive a message password changed successfully")
	public void customer_will_receive_a_message_password_changed_successfully() {
		System.out.println("Password changed successfully");//password changed successfully
	}
	...
	public void fill_details_orders()
	{
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        WebElement firstname, lastname, email,phone, Continue;
		...
		Continue = driver.findElement(By.xpath("//*[@id='tab-customer']//div[14]//button"));   

		action.moveToElement(firstname).click(firstname).sendKeys("Soundarya").
		moveToElement(lastname).click(lastname).sendKeys("V S").
		moveToElement(email).click(email).sendKeys("soundarya126@gmail.com").
		moveToElement(phone).click(phone).sendKeys("9481235670").
		moveToElement(Continue).click(Continue).build().perform();
	...
	public void add_return_details() 
	{
		...
		driver.findElement(By.id("input-email")).sendKeys("soundarya@gmail.com");
	...
	public void fill_voucher_details() 
	{
		...
		driver.findElement(By.id("input-code")).sendKeys("Major108");
		driver.findElement(By.id("input-from-name")).sendKeys("Soundarya");
		driver.findElement(By.id("input-from-email")).sendKeys("soundarya12@gmail.com");
	...
	public void add_new_customer_details() 
	{
		...
		driver.findElement(By.id("input-email")).sendKeys("soundaryavs126@gmail.com");
	...
	public void create_new_custome_field() 
	{
		...
		driver.findElement(By.xpath("//*[@id='custom-field-value-row0']/td[1]/div/input")).sendKeys("keepsmiling");
